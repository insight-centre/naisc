...
public class URITest {
    ...
    public void testMakeLens() {
        ...
        assertEquals(new LensResult(Language.UNDEFINED, Language.UNDEFINED,
                "fragment ID", "fragment id", null), lens.extract(r1, r2).get());
        assertEquals(new LensResult(Language.UNDEFINED, Language.UNDEFINED,
                "fragment id", "a path without a #", null), lens.extract(r3, r4).get());
        ...
        assertEquals(new LensResult(Language.UNDEFINED, Language.UNDEFINED,
                "yet another path", "a path without a #", null), lens.extract(r3, r4).get());
