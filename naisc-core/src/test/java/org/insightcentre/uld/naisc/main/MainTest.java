...
public class MainTest {
    ...
    public void testExecuteWithOutput() throws Exception {
        ...
        Dataset leftDataset = new DefaultDatasetLoader.ModelDataset(leftModel, "left", null);
        Dataset rightDataset = new DefaultDatasetLoader.ModelDataset(rightModel, "right", null);
